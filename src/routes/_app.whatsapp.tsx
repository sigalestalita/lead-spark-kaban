...
function WhatsappInbox() {
  ...
  // Realtime: qualquer mudança em conversas → refetch
  useEffect(() => {
  ...
  return (
    <div className="h-screen flex flex-col">
      <header className="px-6 py-4 border-b border-white/5 flex items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-semibold flex items-center gap-2">
            <MessageCircle className="h-5 w-5" /> WhatsApp
          </h1>
          <p className="text-xs text-muted-foreground">Inbox unificado de conversas</p>
        </div>
      </header>
